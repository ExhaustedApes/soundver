...
public class MusicService2 extends Service {
    ...
    public void onCreate() { // Service가 생성될 때 호출되는 메서드
        super.onCreate();
        mediaPlayer = MediaPlayer.create(this, R.raw.game); // MediaPlayer 객체를 생성하고 game.mp3 파일을 재생합니다. (res/raw에 추가해야 합니다.)

        // 소리를 줄입니다. 여기서는 소리를 반으로 줄입니다! 이유 : 게임 효과음이랑 중첩되는 소리 시끄러워서
        mediaPlayer.setVolume(0.5f, 0.5f); // 소리를 반으로 줄입니다.
